...
class ServerConfig(BaseModel):
    ...
    transport: str = Field(default="stdio", description="Transport type (currently only 'stdio' supported)")
...
class ServerInfo(BaseModel):
    ...
    status: ServerStatus = Field(default=ServerStatus.CONFIGURED, description="Current server status")
    created_at: str = Field(..., description="Timestamp when server was created")
    started_at: Optional[str] = Field(None, description="Timestamp when server was started")
    stopped_at: Optional[str] = Field(None, description="Timestamp when server was stopped")
