...
class ChatRequest(BaseModel):
    ...
    model_type: Optional[ModelType] = Field(None, description="Model type: 'small' or 'main'")
    ...
    best_of: Optional[int] = Field(None, description="Number of completions to generate server-side")
    logit_bias: Optional[Dict[str, float]] = Field(None, description="Logit bias adjustments")
    user: Optional[str] = Field(None, description="User identifier")
    functions: Optional[List[ChatFunction]] = Field(None, description="Available functions")
    function_call: Optional[Union[str, Dict[str, str]]] = Field(None, description="Function call to make")
...
class ChatCompletionLogprobsContent(BaseModel):
    ...
    top_logprobs: Optional[List[Dict[str, Any]]] = Field(None, description="Top log probabilities")
...
class ChatCompletionLogprobs(BaseModel):
    ...
    content: List[ChatCompletionLogprobsContent] = Field(..., description="Log probability content")
...
class Choice(BaseModel):
    ...
    logprobs: Optional[ChatCompletionLogprobs] = Field(None, description="Log probabilities")
